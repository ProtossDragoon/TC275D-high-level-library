...
{
    return (Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].ERR);
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerRx(Ifx_ASCLIN *asclin)
{
    return (Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].RX);
}


volatile Ifx_SRC_SRCR *IfxAsclin_getSrcPointerTx(Ifx_ASCLIN *asclin)
{
    return (Ifx_SRC_SRCR *)(&(*(Ifx_SRC*)0xF0038000u).ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].TX);
}
