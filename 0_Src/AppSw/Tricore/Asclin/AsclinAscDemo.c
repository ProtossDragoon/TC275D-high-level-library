...
IFX_INTERRUPT(asclin1TxISR, 0, ISR_PRIORITY_ASC_0_TX)
{
...
IFX_INTERRUPT(asclin1RxISR, 0, ISR_PRIORITY_ASC_0_RX)
{
...
IFX_INTERRUPT(asclin1ErISR, 0, ISR_PRIORITY_ASC_0_ER)
{
...
void AsclinAscDemo_init(void)
{
    ...
    ascConfig.interrupt.erPriority    = ISR_PRIORITY_ASC_0_ER;
